...
extension GoalsVC {
    func setProgress(atIndexPath indexPath: IndexPath) {
        ...
        if chosenGoal.goalProgress < chosenGoal.goalCompletionCount {
    ...
    func fetch(completion: (_ complete: Bool) ->()) {
        ...
        do {
//            if let savedGoals = try managedContext.fetch(fetchRequest) as? [Goal] {
//                self.goals = savedGoals
//                print("Successfully fetched data.")
//                completion(true)
//            } else {
//                debugPrint("Could not fetch, type is not [Goal]")
//                completion(false)
//                return
//            }
